...
export default function FeriasStandsContent() {
      ...
      <main className="bg-[#231F20] min-h-screen">
        ...
        <section className="pt-40 pb-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="flex items-center gap-2 text-white/30 text-xs font-medium mb-10">
              <Link href="/servicios" className="hover:text-white/60 transition-colors">Servicios</Link>
              <span>/</span>
              <span className="text-white/50">Ferias &amp; Stands</span>
            </div>
        ...
        <section className="py-16 px-6 border-t border-white/5">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <p className="text-white font-black text-2xl md:text-3xl leading-tight tracking-tighter">
                ¿Tu próxima feria ya tiene fecha?
              </p>
              <p className="text-white/40 text-base mt-2">
                Cuéntanos tu proyecto y te respondemos con una propuesta en menos de 48 horas.
              </p>
            </div>
            <a
              href={WA_DIAGNOSTICO}
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full font-black text-sm bg-[#EC008C] text-white hover:bg-[#c8007a] transition-colors duration-200 whitespace-nowrap flex-shrink-0"
            >
