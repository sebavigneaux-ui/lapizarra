...
export const proyectos: Proyecto[] = [
  ...
  {
    slug: "novo-nordisk-celebracion-fiestas-patrias-mandarin-oriental",
    cliente: "Novo Nordisk",
    titulo: "Celebración Fiestas Patrias 2026 — Hotel Mandarin Oriental",
    heroFoto: "/galeria20/4.jpg",
    fotos: [
      "/galeria20/4.jpg",
      "/galeria20/5.jpg",
      "/galeria20/1.jpg",
    ...
    objetivo:
      "Novo Nordisk cerraba un año marcado por lanzamientos de alta relevancia para la compañía en Chile, incluyendo hitos como la llegada de Wegovy® al mercado local. Detrás de cada uno de esos lanzamientos hay equipos completos —científicos, representantes médicos, marketing, operaciones— que sostienen meses de trabajo intenso. Organizar una celebración de Fiestas Patrias para empresas de esta magnitud era, para Novo Nordisk, la oportunidad de combinar dos objetivos en una sola instancia: una jornada de integración de equipo y, al mismo tiempo, un reconocimiento explícito al esfuerzo detrás de esos lanzamientos. Bajo ese encargo, la compañía nos convocó para diseñar y producir su Celebración de Fiestas Patrias 2026 en los jardines del Hotel Mandarin Oriental Santiago, un evento corporativo para más de 100 colaboradores que debía sentirse a la vez como una fiesta dieciochera genuina y como una experiencia de marca a la altura del estándar Novo Nordisk.",
    conceptoCreativo:
      "El concepto creativo de este evento de Fiestas Patrias corporativo se construyó sobre una idea central: celebrar la identidad chilena del 18 de septiembre con el nivel de detalle y sofisticación que caracteriza a Novo Nordisk en cada punto de contacto de marca. Los jardines del Hotel Mandarin Oriental fueron intervenidos con una ambientación rústica-elegante —barriles, flores de campo, puertas antiguas, canastos con frutas y un sombrero de huaso como pieza decorativa— combinada con banderines patrios en los colores corporativos de la marca y letras corpóreas «novo nordisk» como punto fotográfico central de la zona lounge. La experiencia gastronómica fue diseñada como un momento protagónico: estaciones de cocina en vivo con chefs trabajando frente a los asistentes, mesas branded con la identidad de Novo Nordisk y una propuesta culinaria de nivel hotelero acorde al venue. El elemento diferenciador de la jornada fueron las mascotas personalizadas de la pluma de producto, vestidas de huaso y china para la ocasión, que animaron la fiesta junto a un dúo folclórico en vivo —guitarra, acordeón y pandereta— y una ronda de cueca con pañuelos que invitó a los colaboradores a bailar entre ellos. Completaron la jornada juegos criollos tradicionales —rayuela de argollas, tres en línea gigante— pensados para generar interacción espontánea entre áreas que normalmente no comparten espacio de trabajo.",
    resultado:
      "La Celebración de Fiestas Patrias de Novo Nordisk en el Hotel Mandarin Oriental reunió a más de 100 colaboradores en una jornada que combinó con precisión sus dos objetivos: integración de equipo y reconocimiento al trabajo detrás de los lanzamientos más importantes del año para la marca. El dúo folclórico, la cueca con las mascotas de producto y los juegos criollos generaron momentos de alta participación espontánea, con colaboradores de distintas áreas compartiendo mesa, baile y juego en un formato que rara vez ocurre en la dinámica habitual de trabajo. La ambientación y la gastronomía, a la altura del estándar del venue, reforzaron el mensaje de que la compañía valora y celebra a su equipo con el mismo nivel de exigencia que aplica a sus lanzamientos de producto. Para Novo Nordisk, la jornada funcionó como el cierre perfecto de un año de hitos relevantes: una instancia donde el reconocimiento no se limitó a las palabras, sino que se tradujo en una experiencia memorable para quienes hicieron posible esos logros. Para LaPizarra, este proyecto confirma que las celebraciones de Fiestas Patrias para empresas, cuando se producen con el mismo estándar que un evento corporativo de primer nivel, son una de las herramientas más efectivas para comunicar reconocimiento genuino a un equipo.",
  },
  {
  ...
  },
  {
    ...
    heroFoto: "/galeria16/1.jpg",
    fotos: [
      "/galeria16/1.jpg",
    ],
    objetivo:
      "Adecco es la compañía de soluciones de recursos humanos más grande del mundo, con presencia en más de 60 países y una propuesta de valor que conecta talento con oportunidad. En Chile, la marca participa activamente en los foros y eventos de mayor relevancia para la comunidad de gestión de personas. The Annual HR Conference 2026 de Seminarium es uno de los encuentros más importantes del año para gerentes y directores de recursos humanos en el país: una audiencia de alta concentración, alto poder de decisión y alta receptividad a propuestas que les aporten valor real. En ese contexto, Adecco nos convocó para diseñar una activación BTL que funcionara como lead magnet efectivo dentro de la feria: una propuesta capaz de atraer a los asistentes de manera genuina, generar una experiencia memorable con la marca y capturar datos de contacto de potenciales clientes. El desafío era crear algo que, en el contexto ruidoso de una feria de alto nivel, lograra detener a las personas, involucrarlas y dejarlas con algo tangible que valoraran.",
    conceptoCreativo:
      "La idea fue tan simple como poderosa: ofrecer a cada gerente de recursos humanos una fotografía profesional para actualizar su perfil de LinkedIn, de manera gratuita, rápida y con un resultado de calidad ejecutiva. El concepto lo llamamos «Retrato Ejecutivo by Adecco». Montamos un estudio fotográfico completo dentro de la feria —iluminación profesional, cámara en trípode, fondo neutro— y lo envolvimos con branding de Adecco: un totem iluminado con el nombre de la activación y el claim «Una fotografía profesional, rápida y elegante para fortalecer tu presencia ejecutiva», más banners con ejemplos del resultado final. El insight detrás era preciso: los gerentes de RR.HH. son exactamente el perfil que más valora una buena foto de perfil profesional, porque son ellos quienes revisan los LinkedIn de sus candidatos todos los días. Ofrecerles ese servicio en el contexto de una feria fue una propuesta de valor que ningún stand de la competencia podía igualar. A cambio de la fotografía, los participantes dejaban sus datos de contacto —un intercambio percibido como justo y sin fricción.",
    resultado:
      "La activación superó ampliamente las proyecciones: Adecco obtuvo un 60% más de leads de los esperados para el evento. La fila frente al Retrato Ejecutivo se convirtió en uno de los puntos de mayor densidad de la feria, generando visibilidad orgánica y conversaciones espontáneas que extendieron el alcance de la marca más allá de quienes pasaron por el estudio. Cada gerente que se fotografió se llevó una imagen que usaría —y un recuerdo asociado a Adecco. Para LaPizarra, esta activación confirma un principio que aplicamos en cada proyecto BTL: el mejor lead magnet no es el que promete algo, sino el que entrega algo. Cuando la propuesta de valor es genuina y está bien ejecutada, la conversión se produce de manera natural.",
  },
  {
