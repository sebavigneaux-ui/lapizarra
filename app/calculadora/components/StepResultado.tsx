    ...
    <div ref={ref} className="animate-in fade-in slide-in-from-right-4 duration-400">
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={() => {
            window.open(
              "https://wa.me/56958419326?text=Hola%2C%20acabo%20de%20simular%20mi%20evento%20en%20la%20calculadora%20de%20LaPizarra%20y%20me%20gustar%C3%ADa%20que%20me%20contactaran",
              "_blank",
              "noopener,noreferrer"
            );
            onNext();
